...
train_zone_ax = plt.axes([0.77, 0.58, 0.2, 0.045])
...
def toggle_activation_lines(event=None):
    ...
    if not activation_lines_visible:
        if nnet is None:
            ...
            return
        # Calculate change points over a dense range
